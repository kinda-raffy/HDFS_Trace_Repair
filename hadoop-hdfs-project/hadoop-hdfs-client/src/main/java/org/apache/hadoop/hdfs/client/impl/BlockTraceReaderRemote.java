...
public class BlockTraceReaderRemote implements BlockReader {
    ...
    private void readNextPacket() throws IOException {
        ...
        if (!curHeader.sanityCheck(lastSeqNo)) {
            throw new IOException("BlockTraceReader: error in packet header " +
                    curHeader);
        }
...
//        ourlog.write("In BlockTraceReaderRemote cosntructor, checksumSize: "+checksumSize);
    ...
    /**
     * Create a new BlockReader specifically to satisfy a trace read.
     * This method also sends the OP_READ_TRACE request.
     *
